...
AP_InertialSensor_LSM9DS0::AP_InertialSensor_LSM9DS0(AP_InertialSensor &imu,
    ...
    : AP_InertialSensor_Backend(imu), _dev_gyro(std::move(dev_gyro)), _dev_accel(std::move(dev_accel)), _drdy_pin_num_a(drdy_pin_num_a), _drdy_pin_num_g(drdy_pin_num_g), _rotation_a(rotation_a), _rotation_g(rotation_g), _rotation_gH(rotation_gH), _temp_filter(400, 1)
{
}
